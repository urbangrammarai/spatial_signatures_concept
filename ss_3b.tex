...
coverage.
\martin{You could argue that plot is all indivisable, consistent and exhaustive entity.}
...
\end{theorem}
\martin{We should fix terminology. What is tesselaltion (mesh, process, unit) and what is cell etc.}
...
The ET intersects two perspectives of how space can be understood and organised.
%
