...
% Background - What
How we spatially arrange the building blocks that make up a city matters. It
is important because, on the one hand, encodes many aspects of the phenomena
that created such configuration in the first place; but also because, once in
...
successfully differenciate different parts of a city that were built at
