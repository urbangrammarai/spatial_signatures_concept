...
through what we term “Spatial Signatures”. To provide the appropriate context,
we begin with a detailed and comprehensive definition. Our approach is built
of two main pillars, which we detail subsequently: a new spatial unit to
delineate boundaries between signatures, the enclosed tessellation; and a
methodology to embed form and function characters in this new unit.
