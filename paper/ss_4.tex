...
In this section, we present five illustrations of how the concept of the spatial
signatures concept can be applied in a variety of scenarios, including different
backgrounds but also data landscapes.
%% spatial signature is a conceptual framework which can materialise in different ways
The development of spatial signatures we propose as a way to understand urban form and function
represents a conceptual framework.
As such, any one application of this notion will materialise in different ways depending
...
We would like to stress this section represents a series of illustrations of how the concept of
spatial signatures can be operationalised in a variety of contexts. It is not meant to be
understood as an 
